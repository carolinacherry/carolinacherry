...
function chip(text, markPath, color = "#c9d1d9", stroke = false, markY = 4) {
  ...
  const markSvg = markPath ? `<g transform="translate(${padX},${markY}) scale(${(15 / 24).toFixed(4)})" ${markAttrs}>${markPath}</g>` : "";
