...
function chip(text, markPath, color = "#c9d1d9", stroke = false) {
...
writeFileSync(new URL("link-techcrunch.svg", OUT), chip("TechCrunch", '<path d="M5 12h14"/><path d="m12 5 7 7-7 7"/>', "#c9d1d9", true));
